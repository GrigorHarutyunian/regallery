export const faqData = [
  ...
  {
    title: "Can I change the order of images within a gallery?",
    description:
      "Yes, you can easily customize the order of images within a gallery. Simply drag and drop the images to rearrange them as you prefer.",
    panelId: "panel4",
